	...
	<div class="view" >
		<form id="edit-form" method="post" enctype="multipart/form-data" action="/<?=ADMIN_URL_SIGN?>/adv/article_numbers/editSubmit" target="frame77" onsubmit="editSubmitStart();" >
            ...
            <div class="field-wrapper">
                ...
                <span class="value" >
                    <input type="checkbox" name="active" <?=($item->status->code==Status::ACTIVE || $item ? ' checked="checked" ' : '')?>>
                </span>
                <div class="clear"></div>
            </div>
            ...
            <div class="field-wrapper">
                <span class="label">Коммент (для адм.)<span class="required">*</span>: </span>
                <span class="value">
                    <input type="text" name="staffComment" value="<?=htmlspecialchars($item->staffComment)?>" style="width: 400px; ">
                </span>
                <div class="clear"></div>
            </div>
