	...
	<div class="middle">
		...
		<div class="col main">
			<div class="about">
				...
				<div class="txt">
 					Проект <a href="<?=Route::getByName(Route::MAIN)->url()?>"><?=DOMAIN_CAPITAL?></a> ориентирован на производителей мебели* -  на тех, <b>кто при производстве своего продукта изпользует какие-либо материалы. </b>
					...
					<p><b><a class="red" href="<?=Route::getByName(Route::MAIN)->url()?>"><?=DOMAIN_CAPITAL?></a></b> -  это площадка для обмена информацией по остаткам материалов, сводящая вместе спрос и предложения. Размещая объявления о поиске или наличии остатков, Вы сможете значительно <b class="green">оптимизировать свой бизнес</b>.

					<div style="font-size: .8em; font-style: italic; "><p>* В перспективе проект <a href="<?=Route::getByName(Route::MAIN)->url()?>"><?=DOMAIN_CAPITAL?></a> ставит задачу охватить более широкую область, относящеюся к теме остатков (производство наружной рекламы, строительство, торговля, сервис, и другие сферы производства).</div>
